    ...
    L.WindBarb.Icon = L.Icon.extend({
        ...
        _createPoint: function() {
            ...
            svg = document.createElementNS (xmlns, 'svg');
                ...
                svg.setAttributeNS (null, 'stroke', this.options.lineColor);
                svg.setAttributeNS (null, 'stroke-width', sw);
        ...
        _createBarbs: function(speed) {
			...
			var barbColor = this.options.lineColor;
			svg.setAttributeNS (null, 'stroke', barbColor);
			svg.setAttributeNS (null, 'stroke-width', sw);
			svg.setAttributeNS (null, 'stroke-linecap', "butt");
                ...
                if(b[50]>0){
                    ...
                    for(var i=0;i<b[50];i++){
                        ...
                        var path = document.createElementNS (xmlns, "polygon");
                            path.setAttributeNS (null, 'fill', barbColor);                                
